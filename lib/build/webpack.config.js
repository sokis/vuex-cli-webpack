...
var _config$globals = _merge2.default.globals;
...
var webpackConfig = {
	name: 'client',
	target: 'web',
	devtool: _merge2.default.compiler_devtool,
	resolve: {
		root: paths.client(),
...
webpackConfig.entry = {
	app: __DEV__ ? APP_ENTRY_PATHS.concat('webpack-hot-middleware/client?path=' + _merge2.default.compiler_public_path + '__webpack_hmr') : APP_ENTRY_PATHS,
	vendor: _merge2.default.compiler_vendor
};
...
webpackConfig.output = {
	filename: '[name].[' + _merge2.default.compiler_hash_type + '].js',
	path: paths.dist(),
	publicPath: _merge2.default.compiler_public_path
};

// ------------------------------------
// Plugins
// ------------------------------------
webpackConfig.plugins = [new _webpack2.default.DefinePlugin(_merge2.default.globals), new _htmlWebpackPlugin2.default({
...
;if (_merge2.default.compiler_css_modules) {
...
webpackConfig.vue = {
	postcss: function postcss(pack) {
		...
		return [require('postcss-import')({
			root: _merge.utils_paths.client('styles'),
			path: _merge.utils_paths.client('styles'),
			addDependencyTo: pack
		}), require('postcss-url')(), require('postcss-custom-properties')({
			variables: require(_merge.utils_paths.client('styles/variables'))
		}), require('postcss-mixins')({
			mixinsDir: _merge.utils_paths.client('styles/mixins')
