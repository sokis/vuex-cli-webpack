...
exports.default = function () {
  ...
  if (_merge4.default.proxy && _merge4.default.proxy.enabled) {
    app.use((0, _koaConvert2.default)((0, _koaProxy2.default)(_merge4.default.proxy.options)));
  } else if (_merge4.default.server_mock) {
    // mocking .
  ...
  // ------------------------------------
  if (_merge4.default.env === 'development') {
    var compiler = (0, _webpack2.default)(_merge2.default);

    // Enable webpack-dev and webpack-hot middleware
    var publicPath = _merge2.default.output.publicPath;
...
var _merge = require('../build/merge');
...
var _merge3 = require('../config/merge');
...
var paths = _merge4.default.utils_paths;
var port = _merge4.default.server_port;
var host = _merge4.default.server_host;
